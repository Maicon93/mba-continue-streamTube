...
/** supertest types `res.body` as `any`; these are the shapes asserted on. */
interface TokenPair {
  access_token: string;
...
type AnyBody = TokenPair & UserBody & ErrorEnvelope;

const body = (res: { body: unknown }): AnyBody => res.body as AnyBody;

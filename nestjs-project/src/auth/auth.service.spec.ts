...
/**
 * Mocks are plain objects of `jest.fn()`s rather than class instances.
 * Declaring them through this mapped type is what keeps `unbound-method`
 * from firing on `expect(service.method)`: a mapped type produces
 * properties, and the rule is about methods losing their `this`.
 */
